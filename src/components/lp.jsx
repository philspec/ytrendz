...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-gray-100 bg-gray-900">
      ...
      <main>
        <section className="container flex flex-col items-center px-4 py-16 mx-auto lg:flex-row">
          <div className="mb-10 lg:w-1/2 lg:mb-0">
            <h1 className="mb-6 text-4xl font-bold text-gray-100 lg:text-5xl">
            ...
            <Button className="bg-purple-600 hover:bg-purple-700" onClick={scrollToLoginForm}>Get Started</Button>
          </div>
          <div className="lg:w-1/2 lg:pl-16" ref={loginFormRef}>
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-gray-100">Sign up / Log in</CardTitle>
                <CardDescription className="text-gray-400">Start analyzing YouTube content today</CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="signup">
                  <TabsList className="grid w-full grid-cols-2 bg-gray-700">
                    <TabsTrigger value="signup" className="data-[state=active]:bg-gray-900">Sign up</TabsTrigger>
                    <TabsTrigger value="login" className="data-[state=active]:bg-gray-900">Log in</TabsTrigger>
                  </TabsList>
                  <TabsContent value="signup">
                    <form className="space-y-4">
                      <Input type="email" placeholder="Email" className="text-gray-100 bg-gray-700 border-gray-600" />
                      <Input type="password" placeholder="Password" className="text-gray-100 bg-gray-700 border-gray-600" />
